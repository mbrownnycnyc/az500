- [overview for AZ500 cirriculum](#overview-for-az500-cirriculum)
  - [course order recommendation](#course-order-recommendation)
...
- [Security Governance](#security-governance)
  - [Governing Azure Resources](#governing-azure-resources)
    ...
    - [summary Governing Azure Resources](#summary-governing-azure-resources)
  ...
  - [Deploying secure infrastructure](#deploying-secure-infrastructure)
    ...
    - [summary Deploying secure infrastructure](#summary-deploying-secure-infrastructure)
  - [Managing Cloud Security Posture](#managing-cloud-security-posture)
    ...
    - [summary Managing Cloud Security Posture](#summary-managing-cloud-security-posture)
  ...
  - [Customizing security policies](#customizing-security-policies)
    ...
    - [summary Customizing security policies](#summary-customizing-security-policies)
  - [securing multi-cloud environments](#securing-multi-cloud-environments)
    ...
    - [summary securing multi-cloud environments](#summary-securing-multi-cloud-environments)
  - [Enabling Cloud Workload Protection (CWP)](#enabling-cloud-workload-protection-cwp)
    ...
    - [Demo: Enabling multi-cloud workload protection](#demo-enabling-multi-cloud-workload-protection)
      ...
      - [review](#review)
    - [summary Enabling Cloud Workload Protection (CWP)](#summary-enabling-cloud-workload-protection-cwp)
  - [Responding to Security Governance Issues](#responding-to-security-governance-issues)
    ...
    - [summary Responding to Security Governance Issues](#summary-responding-to-security-governance-issues)
  - [quiz](#quiz)
- [Security Operations](#security-operations)
  - [Introducing Monitoring on Azure](#introducing-monitoring-on-azure)
    ...
    - [summary Introducing Monitoring on Azure](#summary-introducing-monitoring-on-azure)
  - [configuring monitoring on Azure](#configuring-monitoring-on-azure)
    ...
    - [summary configuring monitoring on Azure](#summary-configuring-monitoring-on-azure)
  ...
  - [Introducing Microsoft Sentinel](#introducing-microsoft-sentinel)
    ...
    - [summary Introducing Microsoft Sentinel](#summary-introducing-microsoft-sentinel)
  - [Collecting SEcurity Events](#collecting-security-events)
    ...
    - [summary Collecting SEcurity Events](#summary-collecting-security-events)
  - [Responding to Security Threats](#responding-to-security-threats)
    ...
    - [summary Responding to Security Threats](#summary-responding-to-security-threats)
...
- [Managing Secrets](#managing-secrets)
  - [Deploying secret storage using Azure Key Vault](#deploying-secret-storage-using-azure-key-vault)
    ...
    - [summary Deploying secret storage using Azure Key Vault](#summary-deploying-secret-storage-using-azure-key-vault)
  - [Managing access to Azure Key Vault](#managing-access-to-azure-key-vault)
    ...
    - [summary Managing access to Azure Key Vault](#summary-managing-access-to-azure-key-vault)
  - [Managing Azure Key Vault Secrets](#managing-azure-key-vault-secrets)
    ...
    - [summary Managing Azure Key Vault Secrets](#summary-managing-azure-key-vault-secrets)
  - [Protecting Key Vault Secrets](#protecting-key-vault-secrets)
    ...
    - [summary Protecting Key Vault Secrets](#summary-protecting-key-vault-secrets)
...
- [Securing compuite and applications](#securing-compuite-and-applications)
  - [securing access to VMs](#securing-access-to-vms)
    ...
    - [Summary securing access to VMs](#summary-securing-access-to-vms)
  - [Providing temporary access to VMs (via Just-in-Time VM access)](#providing-temporary-access-to-vms-via-just-in-time-vm-access)
    ...
    - [summary Providing temporary access to VMs (via Just-in-Time VM access)](#summary-providing-temporary-access-to-vms-via-just-in-time-vm-access)
  - [securing Azure API Management service](#securing-azure-api-management-service)
    ...
    - [demo:](#demo)
    - [summary securing Azure API Management service](#summary-securing-azure-api-management-service)
  ...
  - [securing Azure Container registry](#securing-azure-container-registry)
    ...
    - [summary securing Azure Container registry](#summary-securing-azure-container-registry)
  - [securing Azure Container instances](#securing-azure-container-instances)
    ...
    - [summary securing Azure Container instances](#summary-securing-azure-container-instances)
  - [securing Azure Container Apps](#securing-azure-container-apps)
    ...
    - [summary securing Azure Container Apps](#summary-securing-azure-container-apps)
  - [securing Azure Kubernetes Service (AKS)](#securing-azure-kubernetes-service-aks)
    ...
    - [summary securing Azure Kubernetes Service (AKS)](#summary-securing-azure-kubernetes-service-aks)
  - [monitoring AKS](#monitoring-aks)
    ...
    - [summary monitoring AKS](#summary-monitoring-aks)
  - [Managing authentication for AKS](#managing-authentication-for-aks)
    ...
    - [summary Managing authentication for AKS](#summary-managing-authentication-for-aks)
  - [Securing AKS networking](#securing-aks-networking)
    ...
    - [summary Securing AKS networking](#summary-securing-aks-networking)
  - [quiz](#quiz-3)
- [Securing Storage](#securing-storage)
  - [Securing VM data](#securing-vm-data)
    ...
    - [summary Securing VM data](#summary-securing-vm-data)
  ...
  - [Securing access to Storage Account](#securing-access-to-storage-account)
    ...
    - [summary Securing access to Storage Account](#summary-securing-access-to-storage-account)
  - [Secure access to Azure Blob Storage](#secure-access-to-azure-blob-storage)
    ...
    - [summary Secure access to Azure Blob Storage](#summary-secure-access-to-azure-blob-storage)
  ...
  - [Securing access to Azure Files](#securing-access-to-azure-files)
    ...
    - [summary Securing access to Azure Files](#summary-securing-access-to-azure-files)
  - [Securing Access to Azure Tables and Queues](#securing-access-to-azure-tables-and-queues)
    ...
    - [summary Securing Access to Azure Tables and Queues](#summary-securing-access-to-azure-tables-and-queues)
  - [protecting storage account data](#protecting-storage-account-data)
    ...
    - [summary protecting storage account data](#summary-protecting-storage-account-data)
  - [configing advanced storage account security](#configing-advanced-storage-account-security)
    ...
    - [summary configing advanced storage account security](#summary-configing-advanced-storage-account-security)
...
- [securing databases](#securing-databases)
  - [configuring database authentication](#configuring-database-authentication)
    ...
    - [summary configuring database authentication](#summary-configuring-database-authentication)
  - [Auditing database access](#auditing-database-access)
    ...
    - [summary Auditing database access](#summary-auditing-database-access)
  - [governing databases](#governing-databases)
    ...
    - [summary governing databases](#summary-governing-databases)
  - [protecting sensitive information](#protecting-sensitive-information)
    ...
    - [summary protecting sensitive information](#summary-protecting-sensitive-information)
  ...
  - [configuring database encryption](#configuring-database-encryption)
    ...
    - [summary configuring database encryption](#summary-configuring-database-encryption)
...
- [exploring hybrid cloud networking](#exploring-hybrid-cloud-networking)
  - [understanding hybrid networks](#understanding-hybrid-networks)
    ...
    - [summary understanding hybrid networks](#summary-understanding-hybrid-networks)
  - [connecting azure VNets](#connecting-azure-vnets)
    ...
    - [summary connecting azure VNets](#summary-connecting-azure-vnets)
  ...
  - [summary controlling network traffic flow](#summary-controlling-network-traffic-flow)
  - [connecting medium-sized networks and remotes users part 1](#connecting-medium-sized-networks-and-remotes-users-part-1)
    ...
    - [summary connecting medium-sized networks and remotes users part 1](#summary-connecting-medium-sized-networks-and-remotes-users-part-1)
  - [Connecting medium sized network and remote users part 2](#connecting-medium-sized-network-and-remote-users-part-2)
    ...
    - [demo:](#demo-1)
    - [summary Connecting medium sized network and remote users part 2](#summary-connecting-medium-sized-network-and-remote-users-part-2)
  - [connecting large distributed networks part 1](#connecting-large-distributed-networks-part-1)
    ...
    - [summary connecting large distributed networks part 1](#summary-connecting-large-distributed-networks-part-1)
  - [connecting large distributed networks part 2](#connecting-large-distributed-networks-part-2)
    ...
    - [summary connecting large distributed networks part 2](#summary-connecting-large-distributed-networks-part-2)
...
- [Securing your network perimeter](#securing-your-network-perimeter)
  - [protecting against DOS attacks](#protecting-against-dos-attacks)
    - [exploring Azure DDoS protection](#exploring-azure-ddos-protection)
    - [Azure DDoS protection tiers](#azure-ddos-protection-tiers)
    - [demo: configuring DDoS Protection](#demo-configuring-ddos-protection)
      - [create a DDoS network protection plan](#create-a-ddos-network-protection-plan)
      - [explore associating a network protection plan with VNet](#explore-associating-a-network-protection-plan-with-vnet)
      - [enable DDoS IP protect](#enable-ddos-ip-protect)
    - [summary protecting against DOS attacks](#summary-protecting-against-dos-attacks)
  - [Protecting network boundaries: part 1](#protecting-network-boundaries-part-1)
    - [explorign azure firewall](#explorign-azure-firewall)
    - [choosing SKU](#choosing-sku)
    - [managing azure firewall](#managing-azure-firewall)
    - [managing firewall rules](#managing-firewall-rules)
      - [management hierarchy](#management-hierarchy)
      - [packet processing order](#packet-processing-order)
    - [forced tunneling](#forced-tunneling)
    - [summary Protecting network boundaries: part 1](#summary-protecting-network-boundaries-part-1)
  - [protecting network boundaties: part 2](#protecting-network-boundaties-part-2)
    - [demo: configuring Azure Firewall](#demo-configuring-azure-firewall)
      - [create the Firewall subnets](#create-the-firewall-subnets)
      ...
      - [create user-defined routes](#create-user-defined-routes)
      - [assocaite a route table with a subnet](#assocaite-a-route-table-with-a-subnet)
      - [create DNAT rule](#create-dnat-rule)
      - [test with DNAT rule](#test-with-dnat-rule)
  - [LAB: attach a firewall to a VNet in Azure](#lab-attach-a-firewall-to-a-vnet-in-azure)
  - [LAB: Configure Application-Level Rules within Azure Firewall](#lab-configure-application-level-rules-within-azure-firewall)
    - [Log in to the Azure Portal](#log-in-to-the-azure-portal)
    - [Remote into the Jump VM](#remote-into-the-jump-vm)
    - [Remote into the Work VM from the Jump VM](#remote-into-the-work-vm-from-the-jump-vm)
    - [Attempt to Open www.google.com from the Work VM](#attempt-to-open-wwwgooglecom-from-the-work-vm)
    - [Configure the Firewall Rule to Allow Access to www.google.com from the Work VM](#configure-the-firewall-rule-to-allow-access-to-wwwgooglecom-from-the-work-vm)
    - [Retry Opening www.google.com from the Work VM](#retry-opening-wwwgooglecom-from-the-work-vm)
  - [Securing individual public endpoints](#securing-individual-public-endpoints)
    - [securing public endpoints](#securing-public-endpoints)
    - [demo: configing service firewall](#demo-configing-service-firewall)
      - [configure for storage account](#configure-for-storage-account)
    - [summary protecting network boundaties: part 2](#summary-protecting-network-boundaties-part-2)
  - [Providing regional availability](#providing-regional-availability)
    - [exploring Application Gateway](#exploring-application-gateway)
    - [Application Gateway components](#application-gateway-components)
    - [demo: securing Application Gateway](#demo-securing-application-gateway)
      - [deploy Application Gateway wuth end-to-end TLS/ssl](#deploy-application-gateway-wuth-end-to-end-tlsssl)
      - [redirect http to https](#redirect-http-to-https)
      - [update dns](#update-dns)
    - [summary Providing regional availability](#summary-providing-regional-availability)
  - [providing global availability](#providing-global-availability)
    - [exploring Azure Front Door](#exploring-azure-front-door)
    - [Azure Front Door Tiers](#azure-front-door-tiers)
    - [components of Azure Front Door](#components-of-azure-front-door)
    - [demo: configuring Azure Front Door](#demo-configuring-azure-front-door)
      - [review the origin web apps](#review-the-origin-web-apps)
      - [config Azure Front Door instance](#config-azure-front-door-instance)
      - [secure access to the origins](#secure-access-to-the-origins)
    - [summary providing global availability](#summary-providing-global-availability)
  - [LAB: Configure Azure Front Door Service](#lab-configure-azure-front-door-service)
    - [Configure Azure Front Door](#configure-azure-front-door)
  - [introduction to WAF](#introduction-to-waf)
    - [exploring WAF](#exploring-waf)
    - [App Gateway vs. Azure Front Door](#app-gateway-vs-azure-front-door)
    - [demo: config a WAF policy](#demo-config-a-waf-policy)
      - [upgrade the Front Door Tier](#upgrade-the-front-door-tier)
      - [Create and associate a WAF policy with Azure Front Door](#create-and-associate-a-waf-policy-with-azure-front-door)
    - [summary introduction to WAF](#summary-introduction-to-waf)
  - [securing application traffic](#securing-application-traffic)
    - [securing Azure App traffic](#securing-azure-app-traffic)
    - [demo: securing azure app service with ssl/tls](#demo-securing-azure-app-service-with-ssltls)
      - [configure a custom domain](#configure-a-custom-domain)
      - [configure SSL/TLS binding](#configure-ssltls-binding)
      - [force HTTPS only and set the minimum TLS verion](#force-https-only-and-set-the-minimum-tls-verion)
    - [securing private app traffic](#securing-private-app-traffic)
    - [demo: implement Entra Application Proxy](#demo-implement-entra-application-proxy)
      - [config private app](#config-private-app)
      - [config app access](#config-app-access)
      - [review security options](#review-security-options)
      - [test access](#test-access)
  - [summary securing application traffic](#summary-securing-application-traffic)
- [securing networks](#securing-networks)
  - [Accessing Platform Services Privately Part 1](#accessing-platform-services-privately-part-1)
    - [configuring service endpoints](#configuring-service-endpoints)
    - [demo: configuring service endpoints](#demo-configuring-service-endpoints)
      - [configure the Service Firewall and Service Endpoint](#configure-the-service-firewall-and-service-endpoint)
      - [review system routes](#review-system-routes)
    - [summary Accessing Platform Services Privately Part 1](#summary-accessing-platform-services-privately-part-1)
  - [LAB: create service endpoints between VMs and blob storage](#lab-create-service-endpoints-between-vms-and-blob-storage)
  - [accessing platform services privately: part 2](#accessing-platform-services-privately-part-2)
    - [exploring private endpoints](#exploring-private-endpoints)
    - [demo: configuring private endpoints](#demo-configuring-private-endpoints)
      - [disable public endpoint on Azure SQL DB](#disable-public-endpoint-on-azure-sql-db)
      - [create a private endpoint for Azure SQL database](#create-a-private-endpoint-for-azure-sql-database)
      - [review DNS config](#review-dns-config)
    - [summary accessing platform services privately: part 2](#summary-accessing-platform-services-privately-part-2)
  - [LAB: Securely Connect a Web App to Azure SQL Database Using Private Link](#lab-securely-connect-a-web-app-to-azure-sql-database-using-private-link)
  - [Enabling Virtual Network Access for Applications](#enabling-virtual-network-access-for-applications)
    - [VNet integration](#vnet-integration)
    - [VNet integration gotchas](#vnet-integration-gotchas)
    - [demo: configuring VNet integration](#demo-configuring-vnet-integration)
      - [confirm App Service Plan prereqs](#confirm-app-service-plan-prereqs)
      - [config VNet integration](#config-vnet-integration)
    - [summary Enabling Virtual Network Access for Applications](#summary-enabling-virtual-network-access-for-applications)
  - [Filtering Network traffic](#filtering-network-traffic)
    - [exploring NSGs](#exploring-nsgs)
    - [demo: configuring NSGs](#demo-configuring-nsgs)
      - [create an NSG](#create-an-nsg)
      - [link an NSG to the subnets](#link-an-nsg-to-the-subnets)
      - [create NSG rules](#create-nsg-rules)
      - [review effective sec rules](#review-effective-sec-rules)
    - [summary Filtering Network traffic](#summary-filtering-network-traffic)
  - [simplifying network traffic filtering](#simplifying-network-traffic-filtering)
    - [using service tags](#using-service-tags)
    - [using Applciation Security Groups](#using-applciation-security-groups)
    - [demo: simplifying network traffic filtering](#demo-simplifying-network-traffic-filtering)
      - [create an ASG](#create-an-asg)
      - [associate ASG with VMs](#associate-asg-with-vms)
      - [update sec rules to use Service Tags and ASGs](#update-sec-rules-to-use-service-tags-and-asgs)
    - [summary simplifying network traffic filtering](#summary-simplifying-network-traffic-filtering)
  - [LAB: Configure Application Security Groups in Azure](#lab-configure-application-security-groups-in-azure)
  - [Monitoring and tshooting network traffic](#monitoring-and-tshooting-network-traffic)
    - [introducing Network Watcher](#introducing-network-watcher)
    - [exploring Flow Logs](#exploring-flow-logs)
    - [demo: configuring flow logs](#demo-configuring-flow-logs)
      - [config VNet flow log](#config-vnet-flow-log)
      - [review](#review-1)
    - [summary Monitoring and tshooting network traffic](#summary-monitoring-and-tshooting-network-traffic)
  - [quiz](#quiz-7)
...
- [Managing Identities](#managing-identities)
  - [Differentiating authentication and authorization](#differentiating-authentication-and-authorization)
    - [authentication vs. authorization](#authentication-vs-authorization)
    - [securing modern environments](#securing-modern-environments)
    - [authentication and authorization protocols](#authentication-and-authorization-protocols)
    - [summary Differentiating authentication and authorization](#summary-differentiating-authentication-and-authorization)
  - [understanding identity providers](#understanding-identity-providers)
    - [exploring identity providers](#exploring-identity-providers)
    - [exploring Microsft Entra](#exploring-microsft-entra)
    - [differences between Azure AD and AD DS](#differences-between-azure-ad-and-ad-ds)
      - [synchronizing identities](#synchronizing-identities)
    - [Azure AD Licensing](#azure-ad-licensing)
    - [summary understanding identity providers](#summary-understanding-identity-providers)
  - [understanding security principals](#understanding-security-principals)
    - [exploring security principals](#exploring-security-principals)
      - [user principal](#user-principal)
      - [service principal](#service-principal)
      - [devices](#devices)
    - [introducing groups](#introducing-groups)
    - [summary understanding security principals](#summary-understanding-security-principals)
  - [managing users](#managing-users)
    - [managing users](#managing-users-1)
    - [updating users](#updating-users)
    - [demo: managing AAD users](#demo-managing-aad-users)
      - [create a backup Global Administrator account using the Azure portal](#create-a-backup-global-administrator-account-using-the-azure-portal)
      - [create a user account for Kristin using Azure Powershell](#create-a-user-account-for-kristin-using-azure-powershell)
    - [summary managing users](#summary-managing-users)
  ...
  - [Understanding Groups](#understanding-groups)
    - [azure AD group types](#azure-ad-group-types)
      - [security groups](#security-groups)
      - [Microsoft 365 group](#microsoft-365-group)
    - [azure AD group membership](#azure-ad-group-membership)
      - [group membership types](#group-membership-types)
    - [managing group members](#managing-group-members)
    - [group lifecycle](#group-lifecycle)
    - [summary Understanding Groups](#summary-understanding-groups)
  - [managing groups](#managing-groups)
    - [demo: managing groups](#demo-managing-groups)
      - [review the default group settings](#review-the-default-group-settings)
      - [create a security group with assigned membership](#create-a-security-group-with-assigned-membership)
      - [create a security group with dynamic membership](#create-a-security-group-with-dynamic-membership)
      - [manage groups as a group owner](#manage-groups-as-a-group-owner)
  - [LAB: Create and Manage Azure AD Groups in the Portal](#lab-create-and-manage-azure-ad-groups-in-the-portal)
  - [Managing Service Principals](#managing-service-principals)
    - [understanding service principals](#understanding-service-principals)
      - [creation of service principals](#creation-of-service-principals)
      - [roles and perms](#roles-and-perms)
      - [managed identity versus service principals](#managed-identity-versus-service-principals)
    - [service principal authentication](#service-principal-authentication)
    - [registering applications](#registering-applications)
    - [demo: managing application registration and service principals](#demo-managing-application-registration-and-service-principals)
      - [config app registration perms](#config-app-registration-perms)
      - [create a service principal uising the Azure portal and AZ powershell](#create-a-service-principal-uising-the-azure-portal-and-az-powershell)
      - [obtain password property](#obtain-password-property)
    - [summary Managing Service Principals](#summary-managing-service-principals)
  - [managing identities for azure resources](#managing-identities-for-azure-resources)
    - [understandign managed identities](#understandign-managed-identities)
    - [managed identity types](#managed-identity-types)
    - [lifecycle of managed identities](#lifecycle-of-managed-identities)
    - [demo: working with managed identities](#demo-working-with-managed-identities)
      - [assign a managed identity using the Azure portal](#assign-a-managed-identity-using-the-azure-portal)
      - [use AZ powershell to remove, assign and maintain managed identities](#use-az-powershell-to-remove-assign-and-maintain-managed-identities)
      - [login to powershell using the managed identity](#login-to-powershell-using-the-managed-identity)
    - [summary managing identities for azure resources](#summary-managing-identities-for-azure-resources)
  - [managing external identities](#managing-external-identities)
    - [enabling external identities](#enabling-external-identities)
    - [Azure AD B2B](#azure-ad-b2b)
    - [demo: Azure AD B2B Collaboration](#demo-azure-ad-b2b-collaboration)
      - [config external collaboration settings](#config-external-collaboration-settings)
      - [config additional IdPs](#config-additional-idps)
      - [setup user flow to use with self-service sign up](#setup-user-flow-to-use-with-self-service-sign-up)
      - [invite user](#invite-user)
    - [Usign Azure AD B2C](#usign-azure-ad-b2c)
    - [summary managing external identities](#summary-managing-external-identities)
  - [quiz](#quiz-8)
- [managing authentication](#managing-authentication)
  - [enhancing authentication](#enhancing-authentication)
    - [leveling up authentication](#leveling-up-authentication)
    - [enable MFA](#enable-mfa)
    - [security defaults](#security-defaults)
    - [demo: enable MFA](#demo-enable-mfa)
      - [review per user MFA](#review-per-user-mfa)
      - [enable M365 MFA](#enable-m365-mfa)
      - [config security defaults](#config-security-defaults)
    - [summary enhancing authentication](#summary-enhancing-authentication)
  - [implementing conditional access](#implementing-conditional-access)
    - [introducing conditional access](#introducing-conditional-access)
    - [creating conditional access policies](#creating-conditional-access-policies)
    - [demo: implementing conditional access](#demo-implementing-conditional-access)
      - [enable Conditional access for admins](#enable-conditional-access-for-admins)
      - [block legacy auth](#block-legacy-auth)
      - [deny access from specific locations](#deny-access-from-specific-locations)
    - [summary implementing conditional access](#summary-implementing-conditional-access)
  - [protecting identities](#protecting-identities)
    - [introducing Identity PRotection](#introducing-identity-protection)
    - [Configuring Identity Protection](#configuring-identity-protection)
    - [Introducing Password Protection](#introducing-password-protection)
    - [Implementing Password Protection](#implementing-password-protection)
    - [demo: protecting identities and passwords](#demo-protecting-identities-and-passwords)
      - [review legacy methods for creating Identity Protection policies](#review-legacy-methods-for-creating-identity-protection-policies)
      - [create a user risk-based Conditional Access policy](#create-a-user-risk-based-conditional-access-policy)
      - [create a sign-in risk-based policy](#create-a-sign-in-risk-based-policy)
      - [simulate and investigate a risk](#simulate-and-investigate-a-risk)
      - [configure alerts](#configure-alerts)
      - [configure Password Protection](#configure-password-protection)
    - [summary protecting identities](#summary-protecting-identities)
  - [deploying SSO](#deploying-sso)
    - [exploring hybrid identity](#exploring-hybrid-identity)
    - [hybrid identity authentication methods](#hybrid-identity-authentication-methods)
    - [exploring password writeback](#exploring-password-writeback)
    - [azure AD connect cloud sync requirements](#azure-ad-connect-cloud-sync-requirements)
    - [summary deploying SSO](#summary-deploying-sso)
  - [demo: deploying SSO](#demo-deploying-sso)
    - [prepare AAD (create custom domain to match the on prem AD DS domain)](#prepare-aad-create-custom-domain-to-match-the-on-prem-ad-ds-domain)
    - [prepare AD DS](#prepare-ad-ds)
      - [add the domain to AD DS](#add-the-domain-to-ad-ds)
      - [switch user principal names](#switch-user-principal-names)
    - [config Azure AD Connect Cloud Sync](#config-azure-ad-connect-cloud-sync)
    - [password write back and SSPR](#password-write-back-and-sspr)
  - [going passwordless](#going-passwordless)
    - [introducing Passwordless Authentication](#introducing-passwordless-authentication)
    - [exploring authentication options](#exploring-authentication-options)
    - [azure AD passwordless requirements](#azure-ad-passwordless-requirements)
    - [demo: enablign passwordless sign-in with Microsoft authenticator](#demo-enablign-passwordless-sign-in-with-microsoft-authenticator)
      - [explore passwordless wizard](#explore-passwordless-wizard)
      - [enable Microsoft Authenticator and Temporary Access Pass as authentication methods](#enable-microsoft-authenticator-and-temporary-access-pass-as-authentication-methods)
      - [create a Temporary Access Pass](#create-a-temporary-access-pass)
      - [register a user using Microsoft Authenticator](#register-a-user-using-microsoft-authenticator)
    - [summary going passwordless](#summary-going-passwordless)
  - [decentralizing identities](#decentralizing-identities)
    - [introducing Decentralized Identities](#introducing-decentralized-identities)
      - [components:](#components)
    - [Verified Identity Requirements](#verified-identity-requirements)
    - [Demo: Issuing Verified Identities](#demo-issuing-verified-identities)
      - [create an Azure Key Vault](#create-an-azure-key-vault)
      - [set up verified ID](#set-up-verified-id)
      - [create a verified employee cred](#create-a-verified-employee-cred)
      - [issue the verified identity using a sample app](#issue-the-verified-identity-using-a-sample-app)
    - [summary decentralizing identities](#summary-decentralizing-identities)
  - [quiz](#quiz-9)
- [managing authorization](#managing-authorization)
  - [introducing authorization](#introducing-authorization)
    - [introducing azure access management](#introducing-azure-access-management)
    - [exploring the Azure Management hierarchy](#exploring-the-azure-management-hierarchy)
    - [introducing administrative units](#introducing-administrative-units)
    - [demo: managing Azure AD permission scope](#demo-managing-azure-ad-permission-scope)
      - [elevate access as a Global Administrator](#elevate-access-as-a-global-administrator)
      - [manage Administrative Units](#manage-administrative-units)
    - [summary introducing authorization](#summary-introducing-authorization)
  - [using built-in roles](#using-built-in-roles)
    - [differentiating azure AD roles](#differentiating-azure-ad-roles)
    - [azure role types](#azure-role-types)
    - [differentiating azure roles](#differentiating-azure-roles)
    - [assigning roles using groups](#assigning-roles-using-groups)
    - [demo: assign built-in roles](#demo-assign-built-in-roles)
      - [create a role-assignable group in AAD](#create-a-role-assignable-group-in-aad)
      - [assign Virtual MAchine USer Login role at the subscription scope to the helpdesk team group](#assign-virtual-machine-user-login-role-at-the-subscription-scope-to-the-helpdesk-team-group)
    - [summary using built-in roles](#summary-using-built-in-roles)
  - [Customizing Roles](#customizing-roles)
    - [customizing AAD roles](#customizing-aad-roles)
    - [customizing Azure (RBAC) Roles](#customizing-azure-rbac-roles)
    - [custom role requirements](#custom-role-requirements)
    - [demo: creating custom roles](#demo-creating-custom-roles)
      - [create a customer azure AD role, review](#create-a-customer-azure-ad-role-review)
      - [create a custom Azure role](#create-a-custom-azure-role)
    - [summary Customizing Roles](#summary-customizing-roles)
  - [enabling Just-in-Time authorization](#enabling-just-in-time-authorization)
    - [the privilege problem](#the-privilege-problem)
    - [exploring Privileged Identity Management (PIM)](#exploring-privileged-identity-management-pim)
    - [Privileged Identity Management (PIM) requirements](#privileged-identity-management-pim-requirements)
    - [demo: enable PIM for Azure AD and Azure RBAC](#demo-enable-pim-for-azure-ad-and-azure-rbac)
      - [assign an eligible role for Azure resources and review](#assign-an-eligible-role-for-azure-resources-and-review)
      - [assign an eligible role for Azure AD](#assign-an-eligible-role-for-azure-ad)
    - [summary enabling Just-in-Time authorization](#summary-enabling-just-in-time-authorization)
  - [continuously evaluating authorization](#continuously-evaluating-authorization)
    - [exploring privilege sprawl](#exploring-privilege-sprawl)
    - [types of access reviews](#types-of-access-reviews)
    - [access review requirements for roles](#access-review-requirements-for-roles)
    - [demo: completing access reviews](#demo-completing-access-reviews)
      - [create an access review for prived Azure AD roles](#create-an-access-review-for-prived-azure-ad-roles)
      - [perform an access review as one of the delegated reviewers](#perform-an-access-review-as-one-of-the-delegated-reviewers)
      - [complete the access review using the Azure portal](#complete-the-access-review-using-the-azure-portal)
    - [summary continuously evaluating authorization](#summary-continuously-evaluating-authorization)
  - [authorizing applications](#authorizing-applications)
    - [understanding application authorization](#understanding-application-authorization)
    - [providing consent](#providing-consent)
    - [demo: delegate application permissions](#demo-delegate-application-permissions)
      - [review concent settings](#review-concent-settings)
      - [register an app in portal](#register-an-app-in-portal)
      - [manage app permissions](#manage-app-permissions)
      - [config and test the app](#config-and-test-the-app)
    - [summary authorizing applications](#summary-authorizing-applications)
  - [quiz](#quiz-10)
...
* I recommend taking the four training courses in the following order (which is not the order I took them in):
...
### exploring Azure DDoS protection
* on top of other challenges posed by DoS, DoS causes resources to scale up and scale down... which ends up costing the company money.
* Azure has built in protection for Public IP address blocks, but they are quite high and are focused on protecting their infrastructure so that DoS are localized.
* More advanced protection is offered by Azure to protect Public IP address accessible service endpoints from DoS attempts
  
### Azure DDoS protection tiers
* `IP Protection`:
  * cost effective for environments with less than 15 public IP addr
  * protects a single public IP addr
  * no rapid response, cost protection or WAF discounts
* `Network Protection`:
  * cost effective to protect more than 15 public ip addr
  * protects up to 100 public ip addr in a single tenant
  * protects all subscriptions, and regions within a single tenant
  * includes rapid response, cost protection, and WAF discounts and more.
    * ie: if you deploy a WAF to front an App Gateway, the WAF is free.

### demo: configuring DDoS Protection

#### create a DDoS network protection plan
* need a `Network Contributor` role
* have a VNet with PIP.  
* ARM resource search bar> DDoS Protection plan> create
  * note that the resource will be enabled in a region, but the single DDoS protection plan can protect across regions and subscriptions

#### explore associating a network protection plan with VNet
* Go to VNet> settings/DDoS Protection... Enable> select the DDoS protection plan

#### enable DDoS IP protect
* RG> PIP resourc einstance> 
  * Configure:
    * ![](2024-08-15-15-15-13.png)
...
## Protecting network boundaries: part 1

### explorign azure firewall
* stateful firewall with traffic filtering and threat protection
* deploy to a dedicated subnet, generally within a Hub Virtual Network, the subnet must be called `AzureFirewallSubnet`
* configure routing to the firewall using user defined routes at the subnets in the spoke networks

### choosing SKU
* all SKUs offer: HA, and some base features
* `Basic`:
  * designed for small and medium businesses
  * throughput limit: 250 Mbps
  * cannot be upgraded to `Standard` or `Premium` tiers
* `Standard`:
  * designed for larger networks
  * throughput limit: 30 Gbps
  * additionally includes: web content filtering and DNS proxy
* `Premium`:
 * designed for larger networks where compliance is required
 * throughput limit: 100 Gbps
 * additionally includes: IDS, full path URL filtering with TLS termination

### managing azure firewall
* Classic Rules:
  * can be used for a small number of independently operated basic firewalls
  * can only be used with VNet not Virtual WAN
  * firewall rules are managed per-firewall instance
* Azure Firewall Manager Policies
  * can be used to manage Standard ond Premium tier firewalls at scale
  * can be used with VNet and Virtual WAN
  * firewall policeis can be assocaited with firewalls across regions
  * can create a policy herarchy with parent and child policies
  * parent policies must be in the same region as the child policies
  * the policy tier must be the same tier or a lower tier than the tier of the firewall it's associated with

### managing firewall rules
#### management hierarchy
* `Parent Firewall Policy`: always prioritized over child policies (org standards)
  * `Child Firewall Policy`:
    * `Rule Collection Group`: contains any policy (there is no policy outside of a rule collection group).  The group has a priority of 100-65000
      * `Rule Collection`: rules are grouped into rule collections. The rule collection has a priority of 100-65000
        * `DNAT rules`: destination NAT
        * `Network Rules`: five tuple
        * `Application rules`: configure using FQDN

#### packet processing order
* by rule type then by priority order
1. Parent Firewall Policy: DNAT rules
2. Child Firewall Policy: DNAT rules
3. Parent Firewall Policy: network rules
4. Child Firewall Policy: network rules
5. Parent Firewall Policy: application rules
6. Child Firewall Policy: application rules

### forced tunneling
* allows to route all internet-bound traffic through a separate device or NVA
* is configed on firewall provisioning and can be used with all firewall SKUs
...
## protecting network boundaties: part 2

### demo: configuring Azure Firewall

![](2024-08-15-15-50-13.png)

#### create the Firewall subnets
* in hub VNET, settings/subnets> create subnet with Azure Firewall as it's purpose
  * /26 will be default subnet
* create another subnet> create a subnet with Firewall management (forced tunneling) as it's purpose
  * change the subnet

#### create firewall policy
* go to firewall manager> Secure/ azure firewall policies> create
  * set policy tier

#### create an Azure Firewall
* go to firewall manager> security/firewall
  * region needs to match hub VNET
  * VNet hub Vnet
  * add a public IP
  * add management Public IP

#### create a route table
* route table> create> no propagation

#### create user-defined routes
* route table> settings/routes> add
  * route-default> ip address> 0.0.0.0/0
  * next hop: virtual appliance, then back to firewall to get the private IP from the instance> next hop == this ip

#### assocaite a route table with a subnet
* on the route table> settings/subnets> assocaite
  * to spoke VNet

#### create DNAT rule
  * firewall policies> settings> DNAT rules> add rule connection> 100-65000
  * add a rule
    * source: *
    * dst port: 3389
    * dst IP: firewall public IP

#### test with DNAT rule
* yarp

## LAB: attach a firewall to a VNet in Azure
* not currently available, but appears to match the above demo

## LAB: Configure Application-Level Rules within Azure Firewall
...
## Securing individual public endpoints

### securing public endpoints
* almost all PaaS services have a public endpoint that is accessible.  This is not secured by a firewall by default.
  * use cases: on prem access withotu a VPN (whitelist by src IP address)
* you can insert a firewall into the middle to restrict network access to:
  * public and on prem ip addresses
  * trusted MSFT services explicitly
  * VNets (this would also require a service endpoint)

### demo: configing service firewall

#### configure for storage account
* Storage account> security + networking/networking> firewalls and virtual networks tab
  * set public network access to Enabled from selected VNets and ip addresses
    * you can restrict further by proving a range to allow
    * you can add an existing or new VNets (provided that you have service endpoints on that VNet subnet)
    * you can restrict using RBAC and managed identity
      * ![](2024-08-15-16-04-08.png)
    * enable trusted MSFT services
...
## Providing regional availability

### exploring Application Gateway
* provides public and private, operates at layer 7 LB for web apps
* features:
  * tls/ssl encryption and offload
  * url path-based and host header based routing
  * session affinity
* Application Gateway can integrated with WAF for advanced protection

### Application Gateway components
* Frontend IP:
  * public IP
  * private IP
* routing rules: link frontend to backend
  * Listener: frontend port, protocol, and TLS/SSL config
  * backend settings: contains backend tls/ssl cert required to implement end-to-end tls/ssl
  * redirection: can be used to redirect an http listener to a https listener
* backend Pools:
  * collection of resources which serve the data

### demo: securing Application Gateway

![](2024-08-16-04-34-34.png)

#### deploy Application Gateway wuth end-to-end TLS/ssl
* ARM> application gateway
  * ![](2024-08-16-04-36-01.png)
  * front ends
    * ![](2024-08-16-04-36-21.png)
  * backends
    * ![](2024-08-16-04-38-25.png)
  * configuration
    * ![](2024-08-16-04-39-34.png)
    * ![](2024-08-16-04-40-03.png)
 

#### redirect http to https
* application gateway resource instance> settings/listener> add
  * ![](2024-08-16-04-41-05.png)
* application gateway resource instance> settings/rules> add
  * ![](2024-08-16-04-41-26.png)

#### update dns
* get public IP from overview screen of the application gatweay resource instance
* go to t a public DNS Zone> dns management/recordsets
...
### exploring Azure Front Door
* provides public, global, layer 7 traffic distribution for web apps
* front door provides:
  * optimized global routing using anycast
  * tls/ssl encryption and offload
  * URL path-based routing
* can integrate with WAF

### Azure Front Door Tiers
* `Standard`: performance focused and supports any internet-facing backend app
* `Premium`: security focsued and includes all standard features plug MSFT managed WAF rule sets, bot protectiona nd private backend connectivity using Private Link
* can be upgraded from `Standard` to `Premium` without downtime, downgrading is not possible.  WAF policies will need to be upgraded as well.

### components of Azure Front Door
* `Endpoint`: accept traffic usign an Azure provided DNS or custom domain, managed certs for HTTPS (or bring your own certs and DNS)
* `Origins`: serve client requets.  Grouped into `Origin Groups` and traffic is distributed between `origins` in an `origin group`.
  * `Origins` can be many components, like: App Service, Containers, Storage Account, API management, App Gateway
* `Routes`: map domains to `origin group`.  define accepted protocols, redirection, caching and compression settings.
* Security policies: can be added to the endpoint (ie: WAF)

### demo: configuring Azure Front Door

![](2024-08-16-04-57-44.png)

#### review the origin web apps
* ARM> review the web app as configured

#### config Azure Front Door instance
* ARM> search> front door and CDN profiles> create> custom create
  * enter secrets, key vault based
  * endpoint> add a name (this is the front end)
  * route> add>
    * create new origin group
      * create origins
        * ![](2024-08-16-05-00-02.png)
      * ![](2024-08-16-05-00-14.png)

#### secure access to the origins
* go to the web app that's the origin> Settings/Networking> inbound traffic configuration settings
  * add an access restriction rule
    * use the source of a ServiceTag for AzureFrontDoor.Backend
      * ![](2024-08-16-05-02-17.png)
...
## LAB: Configure Azure Front Door Service
...
### exploring WAF
* enhances the security of your web apps by centrally protecting against existing and emerging threats
* WAF supports:
  * App Gatway
  * Front Door
  * CSN
* a WAF policy can be centrally created and applied to either App Gateway or Front Door

### App Gateway vs. Azure Front Door
* App Gateway
  * includes MSFT managed default rule set to protect against known and new exploits
  * you can optionally enable an OWASP core rule set
  * requires the WAF or WAF v2 SKU
  * WAF policy must be deployed to the same region as the App Gateway
* Azure Front Door
  * incldues MSFT managed default rule set based on the OWASP core rule set with added MSFT Threat Intel collection rules to protect agianst known and new exploits.
    * these managed rules are only supported in the `Azure Front Door Premium tier`
  * a single WAF policy can be used with any global Front Door deployment

### demo: config a WAF policy

![](2024-08-16-05-11-30.png)

#### upgrade the Front Door Tier
* go to the existing Front Door and CDN profile resource> settings/configuration
  * under Tier click upgrade

#### Create and associate a WAF policy with Azure Front Door
* ARM search> Firewall Manager> security/Web Application Firewall Policies> create new WAF policy
  * ![](2024-08-16-05-14-47.png)
  * Managed rules
    * Choose latest Microsoft_DefaultRuleSet
    * Association
      * add the front door profile and domain
...
### securing Azure App traffic
* enable TLS to provide server authentication, message privacy, encryption in trasit, and data integrity for network traffic between your Azure services and end users.
* some azure services offer MSFT provided certs or youc an bring your own certs
* Azure App Service, Azure API Management and many other Azure services support TLS to secure app and API traffic

### demo: securing azure app service with ssl/tls

![](2024-08-16-05-20-47.png)

#### configure a custom domain
* go to Web App resource overview page and copy the Default domain
  * settings/custom domains> add
    * ![](2024-08-16-05-22-26.png)
    * perform DNS validation using the A and TXT records
      * via accessing the public DNS zone
#### configure SSL/TLS binding
* go to Web App resource overview page
* in the Custom domain list, under Solution, click Add binding
  * SNI SSL
    * ![](2024-08-16-05-24-08.png)

#### force HTTPS only and set the minimum TLS verion
* go to Web App resource overview page
* Settings/configuration/general settings
  * find and set `HTTPS Only` to on and set the minimum inboudn TLS
    * these types of settings can be enforced by Azure Policy

### securing private app traffic
* Entra Application Proxy provides secure remote access to private applications (reverse proxy) (even on prem)
* Application Proxy can perform Entra pre-auth to enable support for conditional access
* the Private Network Connector can auth to the application using the Entra credentials to provide SSO
* note that you never need to open inbound ports to provide access

### demo: implement Entra Application Proxy

![](2024-08-16-05-28-28.png)

#### config private app
* go to Entra Admin Center> Identity> Applications> enterprise applications> new applicaiton (requires `applicaiton adminsitrator` entra role)
  * add new on premises application
    * ![](2024-08-16-05-30-26.png)
    * Internal URL: this should be the DNS name of the server as accessed by the Connector executable that will be deployed inside your on prem network
    * pre auth: passthrough is open access
  * download the connector service and install on server

#### config app access
* go to Private network connectors> enteprrise applications and select the resource you just created> manage/users and groups
  * add an assignment

#### review security options
* go to Private network connectors> enteprrise applications and select the resource you just created>
  * manage/single sign-on> this will help with SSO integratation for app compatibility
  * security/conditional access: this is the conditional access policy 
...
## Accessing Platform Services Privately Part 1

### configuring service endpoints
* use `service endpoints` to enable secure, private access to PaaS resources
  * Azure will insert route into the subnet routing table to redirect
* configure service firewall to deny public access
* service endpoints are enabled per subnet, per azure service
* service endpoints are supported on many Azure services including: storage accounts, SQL Database, Key vault and more
* use Service Endpoint Policies to protect allow traffic to only specific azure resources and prevent data exfil
* Azure Firewall can be used with Service Endpoints to centrally control and log traffic to service endpoints
  * using NATs the Firewall subnet as a centralized access point for Service Endpoints

### demo: configuring service endpoints

![](2024-08-16-06-06-48.png)

#### configure the Service Firewall and Service Endpoint
* RG> storage account> security + networking/networking
  * public network access: enabled from selected virtual networks and IP addreses
  * under Virtual networks> select the VNet and prod subnet
    * Service Endpoint will automatically be created

#### review system routes
* ARM> network interfaces> select a NIC that's attached to a VM on the prod subnet> help> effective routes
  * ![](2024-08-16-06-09-51.png)
...
## LAB: create service endpoints between VMs and blob storage

* go to storage account and enable service endpoint on the subnet
* review the VM's NIC's route table to verify that the service endpoint route is present

## accessing platform services privately: part 2

### exploring private endpoints
* a private endpoint is basically a VNet local point-of-access for another resource
* private Endpoints provide private access to individual Azure PaaS
* must be int he same region as the VNet, but not necessarily the same region as the resource
* enable connectivity from all connected networks
* access is configured per resource
* private endpoints require DNS, you can link a Private DNS Zone for this automatic resource record mgmt

### demo: configuring private endpoints

![](2024-08-16-08-15-50.png)

#### disable public endpoint on Azure SQL DB
* access to RG> Sql Server> security/networking> public access> disable
  * this immediately stops access

#### create a private endpoint for Azure SQL database
* access to RG> Sql Server> security/networking> private access> create private endpoint
  * place in a subnet
  * DNS> integrate with private DNS Zone

#### review DNS config
* When you create a private endpoint with private DNS Zone integration, Azure automatically changes the public DNS name of your resource to a CNAME matching your private DNS zone name
  * ![](2024-08-16-08-19-08.png)
  * in the private DNS zone, you can review the config via settings/Virtual network links
...
## LAB: Securely Connect a Web App to Azure SQL Database Using Private Link
* this lab is unavailable

## Enabling Virtual Network Access for Applications

* `VNet integration` provides private outbound access
* `Private Endpoints` provide private inbound access

### VNet integration
* App Service Environment (web app, function app, logic app)
  * Isolated tier will offer App Services within your own VNet
  * other tiers deploy App Service Plan to shared infrastructure
* App service plan: Regional VNet integation from App Service Plan into VNet's subnet
  * inter-region via a Gateway-required VNET integration using P2S VPN

### VNet integration gotchas
* a dedicated subnet that is delegated to Azure App Service is required /26 is recommended
* there's no support mounting network drives or performing ADDS domain join
* NSGs are supported for outbound traffic filtering.  Inbound filtering is done via PRivate Endpoint or service firewall.
* Routing config determines which type of traffic are sent via the VNet, and route tables can be used for controllign traffic flow

### demo: configuring VNet integration

![](2024-08-16-08-28-27.png)

#### confirm App Service Plan prereqs
* go to app service plan resource> settings> scale up (App Serviec plan)> switch to Feature view
* Review vNet integration column (the only service plans that do not support are F1 and D1)

#### config VNet integration
* go to Web App> settings> networking
* under Outbound traffic configuration> VNet integration> 
  * if clients are in same region: add> select the VNet and subnet
  * if clients are in other region: Gateway-based integration> configure a gateway, and P2S VPN connection to other region's VNet
* you can then restrict whether the Application can send to the internet, and you can configure routing, NSG, route table, NAT gateway, etc.
...
### exploring NSGs
* NSGs can be assocaited with either NICs or subnets, or both
* NSG can be assocaited with many subnets and NIUCs int he same subscription and region
* Security Rules:
  * default rules allow traffic within a vnet, all connected networks, Azure LBs, and to the Internet
  * default rules deny inboudn traffic from outside the VNet
  * Rules are stateful
  * rules are processed in priority order 100-4096
  * rules are directional (inbound or outbound)
  * when a matching rule is found, no further rule is processed
* NSGs are processed east-west in the same subnet, if the NICs have NSGs.  Subnets may have NSGs as well.

### demo: configuring NSGs

![](2024-08-16-08-39-29.png)

#### create an NSG
* ARM> network security groups> create

#### link an NSG to the subnets
* go to NSG resources> settings/subnets
  * associate with three subnets
* go to NSG resources> settings/network interfaces
  * associate with three VM's NICs

#### create NSG rules
* go to NSG resources> settings/inbound security rules
  * add a denyall inbound rule
  * allow bastionsubnet, and the other rules as diretcted

#### review effective sec rules
* help> effective security rules bound to NIC
...
## simplifying network traffic filtering

### using service tags
* Augmented Security Rules uses named groups of IP addr instead of using CIDR block ranges
* a Service Tag is a group of IP prefixes that represent a service or network segment (generally these are managed by MSFT themselves for various Azure services or dynamically within your tenant)
* Service Tags can be used in NSG rules, Azure firewall destinations and as a source in user-defined routes
* common service tags:
  * "Virtual Network": represents the VNet in focus, and ALL connected VNets and on prem/cloud networks
  * "Internet": represents the public IP address space
* some Service Tags offer a regional scope to narrow the range to a specific region

### using Applciation Security Groups
* ASGs allow you to group VMs and apply security rules using the group
* limitations
  * all NICs assigned to an ASG must exist int he same Vnet
  * when an ASG is used as the source and destination, all NICs must exist in the same VNet

### demo: simplifying network traffic filtering

![](2024-08-16-08-57-06.png)

#### create an ASG
* ARM> Create
* go to ASG resource isntance
  
#### associate ASG with VMs
* go to VMs> networking/application security groups> add> add ASG

#### update sec rules to use Service Tags and ASGs
* go to NSG resource> settings/inbound security rules
  * source: service tag "internet"
  * destination: ASG> the new ASG name
...
## LAB: Configure Application Security Groups in Azure
* yarp

## Monitoring and tshooting network traffic

### introducing Network Watcher
* Network Monitor provides a suite of tools to monitor network traffic of IaaS resources
  * not design to monitor PaaS or SaaS resources
* Tools:
  * Monitoring: Connection Monitor, Topology
  * Network Diagnostic Tools: ip flow verify, NSG diagnostics (allows you to create rules with a higher priority if there are issues that need to be resolved), next hop, effective security rules, VPN Troubleshoot, packet capture, connection troubleshoot
  * traffic analysis: flow logs, traffic analytics

### exploring Flow Logs
* flow logs collect flow info about ip traffic that flows through NSG or VNet (five tuple)
* flow logs require a Standard General Purposev2 storage account in the same region and tenant as the observed resources
* there are two types of flow logs:
  * NSG flow logs: two versions:
    * version 1: allowed and denied network traffic
    * Version 2: provides additional throughput info
  * VNet flow logs: provide additional features and are considered easier to config

### demo: configuring flow logs

#### config VNet flow log
* Subscruptions> settings/Resource providers> must have microsoft.insights provider is registered
* Network Watcher> logs/flow logs> create
  * subscription
  * Virtual network (could select a subnet or NIC)
  * assign a storage account
  * enable traffic analytics

#### review
* written to storage account as json data
* Network Watcher> Monitoring/Traffic Analytics
...
## quiz
* When securing an Azure SQL Managed Instance, which of the following would be part of the implementation?
  * Private endpoints
* Which Azure service provides private connectivity to public Azure services from within a subnet?
...
* who?
  * authentication: identity verification process, generally by presenting creds
* what?
  * authorization: granting or denying access and designating an appropriate access level.

### securing modern environments
* previously, there was a lot of reliance on network segmentation and physical security
* now:
  * how are you accessing the system?
  * why do you want access?
  * where are you accessing the system from?
  * how long do you need access for?

### authentication and authorization protocols
* authentication protocols
  * SAML: commonly used for enterprise auth
  * OIDC: cloud native auth mech.
* authorization protocol:
  * OAuth: author access without requiring creds
  * enables delegated access on behalf of a user.
...
### exploring identity providers
* an IdP is a service that stores, manages, and verifies identities
* Entra ID tenant is the security and management boundary for your enterprise
  * you can bring your own ID as well

### exploring Microsft Entra
* suite of identity and access products 
* permissions management: securely manage perms across Azure, AWS and Google Cloud
* verified ID: decentralize identity and allow users to bring their own digital identities
* identity governance: auto manage identity and access usign workflows for assignment, review and expiration
* workload identities: establish a trust relationship between AAD and a workload and provide passwordless access to resources

### differences between Azure AD and AD DS
* AD DS
  * provides IdP for private enterprise networks
  * Domain controllers: LDAP, kerberos, NTLM
* Azure AD:
  * cloud based IdP for enterprise networks
  * SSO, IdP
  * uses modern protocols (OIDC, OAuth 2.0)
* Azure AD DS
  * SaaS based DCs
...
* Azure AD Free:
  ...
  * SSO for Azure, M365 and cloud apps
* Azure AD Premium P1 (M365):
  * hybrid app access with Azure AD Application Proxy
  * Azure AD dynamic groups
  * password writeback (from Azure AD to on prem AD)
  * Conditional Access
  * Password Protection
* Azure AD Premium P2 (M365 E5):
...
### exploring security principals
* identity (a user, group, device, service) that's stored by an IdP that represents

#### user principal
* `User principal`: represent people that access resources secured by Azure AD
* Azure AD has definitions for User Principals:
  * Cloud only users: those that are initially created in Azure AD
  * Directory-synced users: those that are initially created within legacy AD DS and synced to Azure AD
  * Guests: those who you have invited to your Azure AD Tenant

#### service principal
* `Service principal`: represent apps and services that require access to resources secured by AAD (a type of service principal is a `Managed Identity`)
  * `Confidental Client Applications`: application accesses backend on the user's behalf

#### devices
* not a focus on AZ500 exam

### introducing groups
* grouping of security principals and assign access to resources for access
  * can be created in AAD or synced
...
### managing users
| .. | required privs | Powershell | azcli | 
| -- | -- | -- | -- | 
| create | user administrator, global administrator | `new-azaduser` | `az ad user create` |
| read | all members | `get-azaduser` | `az ad user list`, `az ad user show` | 
| update | self update, user administrator, privileged authentication administrator | `update-azaduser` | `az ad user update` |
| delete | user administrator, privileged authentication administator | `remove-azaduser` | `az ad user delete` | 

* deleted users are held for 30 days

### updating users
* synchronization affects updating

| location user created | location user can be updated | 
| -- | -- |
| AD DS | AD DS | 
| AAD | AAD |

* Azure AD has the capability to write-back passwords to legacy AD DS

### demo: managing AAD users

#### create a backup Global Administrator account using the Azure portal
* break glass account
* go to ARM> Entra ID> users> create
  * globaladminbackup
  * assignments> add role> global administrator

#### create a user account for Kristin using Azure Powershell
* create a dedicated admin account
```
install-module az -force
#yes to update nuget
connect-azaccount #auth
convertto-securestring -asplaintext
$username = adminkristen
new-azaduser -displayname $username -passwod $password -userprincipalname "$username@"
```
...
#### security groups
* used to manage access to resources that are secured by Azure AD
* users, devices, other security groups and service principals can all be added as members

#### Microsoft 365 group
* used for collaboration in M365
* provides a shared mailbox, calendar, sharepoint site and Teams workspace
* only users can be members

### azure AD group membership

#### group membership types
* `assigned group membership`: security principals (users, groups, devices) are statically added to the group.
* `dynamic group membership`: security principals (users, devices) are automatically added to the group as determined by their Azure AD user attributes
  * dynamic groups can either be `user groups` or `device groups`
  * service principals cannot be members of dynamic groups
  * a AAD Premium P1 license is required for each group member
  * M365 dynamic groups cannot contain devices

### managing group members
* built-in roles that can manage groups include the `Groups Administrator` and `User Administrator` roles
* group owners can modify the membership of groups they own
* group owners can be assigned to both M365 and security group types
* group owners cannot modify dynamic group membership rules
* at least as AAD premium P1 license is required for users to request to join a security group or M365 group.
* as with object, you'd expect that if the owner/creator of a group is a user, then other users of the same rights level can join their group.

### group lifecycle
* create: by default any AAD member can create both M365 and security groups
* read: by default any AAD member can read groups, their properties and their members
* update: for groups created by non-admin users, membership approval is customizable (yes/no require approval)
  * only prived roles and group owners can update group membership for groups created by an admin
* delete: group owners and admin roles can delete groups.  Delete M365 groups are retained for 30 days.
...
#### review the default group settings
* go to Entra ID> manage/groups> settings/general
  * self-service group management
  * security groups and M365 groups

#### create a security group with assigned membership
* go to Entra ID> manage/groups> create a security group
  * membership type: assigned user
  * add a user
...
#### manage groups as a group owner
* myapps.microsoft.com>
* my apps> my groups
  * groups I own

## LAB: Create and Manage Azure AD Groups in the Portal
* yarp
* note that M365 groups are retained when deleted, sec groups are not

## Managing Service Principals

### understanding service principals
* used by apps and background processes to access other resources via AAD

#### creation of service principals
* via Application Registration
  * note that application registration can leverage `delegated permissions` to act on the behalf of a user
    * delegation is an interactive process
* via Managed Identity (service principal for a resource)

#### roles and perms
* roles and permissions can be assigned to an SP as you would any other identity

#### managed identity versus service principals
* not all azure services support managed identities
* service principals can be used outside of Azure (like on prem)
* service principals can be created in multiple tenants

### service principal authentication
* password based: uses a simple set of creds to auth your app including a secret and an app ID (or client ID)
* cert based: users certs to auth your app without sending creds.  Considered to be more secure than password-based auth.
  * can validate with third party
  * creds are never sent across the wire

### registering applications
* by default, any AAD member user can register an app that they are deving.  If this setting is disabled, a role is required to manage apps.
* roles involved:
  * `Application Developer`: can register apps they are developing and delegate perms to the app on their behalf
    * will automatically get ownership of the Application when they register it.
  * `Cloud Application Administrator`: can manage all app registrations, request consent for the app, and access all app creds
  * `Application Administrator`: can approve non-MSFT graph consent requests and manage Application Proxy.

### demo: managing application registration and service principals

#### config app registration perms
* entra ID> manage/user settings> default user role permissions: users can register applications == yes

#### create a service principal uising the Azure portal and AZ powershell
* manage/app registrations> create
* with powershell:
```
connect-azaccount
$sp = new-azadserviceprincipal -displayname "securitScanner"
```
* check service principals in Enterprise Applications section of ARM> Manage/all applications

#### obtain password property
```
...
### understandign managed identities
* managed identities allow Azure resources to auth with AAD and access resources that are secured by AAD
* managed identities work with many Azure resources
* Azure Arc enables managed identities outside of Azure

### managed identity types
* system assigned 
  * associate with a single Azure resource
  * lifecycle is shared with the resource itself
  * typically used to grant access for individual resources
* user-assigned
  * associated with one or more azure resources
  * an azure resource can have multiple user-assigned identities
  * independent lifecycle to associated resources
  * useful for groups of resources that share a common function (ie: VMSS, etc)
* a resource can use multiple identities 

### lifecycle of managed identities
* role-to-action matrix

| managed identity type | Create | update | read | delete
| -- | -- |-- |-- | -- |
| system-assigned | Virtual Machine Contributor | Virtual Machine Contributor | Reader (on resource) | Virtual Machine Contributor | 
| user-assigned | Managed Identity Contributor OR Virtual Machine Contributor and Managed Identity Operator (for VMs) | Managed Identity Contributor OR Virtual Machine Contributor and Managed Identity Operator (for VMs) | Reader (on resource) | Virtual Machine Contributor | 

### demo: working with managed identities

#### assign a managed identity using the Azure portal
* ARM> Managed identities> create> select RG
* go to VM> settings/identity> user assiigned> select> add

#### use AZ powershell to remove, assign and maintain managed identities
```
get-azvm
update-avm -vm #vm -identitytype none
update-azvm -vm #vm -identitytype SystemAssigned

$vmsp = get-azadserviceprincipal -displayname "vm1"
# assign role to system managed identity
new-azroleassignment -objectid $vmsp.id -resourcegroupname "rg" -roledefinitionname "Virtual Machine Contributor"
```

#### login to powershell using the managed identity
```
...
* `Azure AD B2B`: designed to enable collaboration between companies and other external users, like partners and suppliers, and provide access to almost all resources secured by AAD
* `Azure AD B2C`: designed to publish SaaS apps to customers

### Azure AD B2B
* you can actively invite guests:
  * Option A: who will create a user on your AAD Tenant
  * Option B: who will leverage their external IdP to your tenant (Microsoft account, WS-Federated, Facebook)
  * Option C: AAD tenant B2B Direct Connect (two way trust between orgs)

### demo: Azure AD B2B Collaboration

#### config external collaboration settings
* Entra ID> manage/external identities> external collaboration settings
  * review Guest user access settings:
    * ![](2024-08-16-14-40-35.png)
  * review Guest invite settings:
    * ![](2024-08-16-14-41-18.png)
  * enable guest self-service sign up via user flows

#### config additional IdPs
* Entra ID> manage/external identities> all identitiy providers> add google

#### setup user flow to use with self-service sign up
* Entra ID> manage/external identities> self-service sign up/User flows> new user folow
  * configure, then select B2B app under "Use"

#### invite user
* entra ID> new user> invite external user
* add role

### Usign Azure AD B2C
* a new AAD B2C tenant (IdP) is created that allows customers to register
* supports any SAML based IdP
...
## quiz
* Which of the following features require at least an Microsoft Entra ID P1 license?
  * Password Protection, Password writeback, Conditional Access, and Microsoft Entra Application Proxy
...
* Bad scenario:
  * AD DS on prem, and AAD is used for some SSO
  * no SSO integration
  * identitties might exist across a range of IdPs
  * limited visibility into the identities used in the org
* good scenario:
  * SSO across on prem and cloud apps
  * gain visibility into the identities used across the org
  * conditionally request multiple factors of authentication and assigne with identity remediation
* best scenario:
  * MFA enforced
  * use passwordless authentication
  * analyze sign in attributes in real time

### enable MFA
* free version:
  * per-user MFA: considered legacy and available with all editions of AAD
  * security defaults: single checkbox provides a range of best practice security measures
* M365 E3 or E5:
  * enabled unconditionally for all users from M365 portal
* Azure AD Premium P1:
  * Conditional Access based on scenarios or events at login
* Azure AD Premium P2:
  * risk-based Conditional Access policies to improve user experience

### security defaults
* all users will be required to register for Azure AD MFA
* adminsitrators will need to perform MFA
* users will need to perform MFA when necessary (as determined by risks analyzed by Azure)
* Legacy authentication protocols are blocked
* Privileged managmenet activities require MFA

### demo: enable MFA

#### review per user MFA
* entra ID> users> per-user MFA at top
  * legacy portal> trusted locations, etc

#### enable M365 MFA
* go to Microsoft 365 admin center
* setup> under sign-in and security, click Configure MFA
  * what you see depends on the license level
* MFA using security defaults 
* security defaults can be enabled in M365 MFA via the above workflow

#### config security defaults
* entra ID> users> Manage/Properties> there's a small link near the bottom "Manage security defaults"
* entra ID> users> security/authentication methods> manage/policies>
  * admin users should use FIDO2 security keys
...
* logic applies to authentication events
* Signals --> Decision

### creating conditional access policies
* License requirements:
  * All Conditional ACcess policeis require at least Azure AD Premium P1 license
  * Risk-based policies require at least Azure AD Premium P2 license
* user requirements:
  * `Conditional Access Administrator` or `Security Administrator` role
  * a test user account and group if required

### demo: implementing conditional access

#### enable Conditional access for admins
* Entra ID> security> protect/conditional access> Create new policy from templates: require MFA for admins
  * policy state: report only
* policies> select the new policy:
  * assignments:
    * users exclude> 
  * Access controls:
    * grant acess> require multifactor authentication
#### block legacy auth
* policies> create new policy from template> block auth

#### deny access from specific locations
* manage/Named locations> Countries location> 
  * not allowed countries
* policies> create new policy> deny access 
  * Conditions> locations> selected locations> not allowed countries
...
### introducing Identity PRotection
* Azure AD Identity Protection: automates detecting and remediating identity based risks
  * provides reporting in Azure portal
* risk types:
  * User Risk: the probability that an identity is compromised
  * Sign-in risk: the probability that a sign-in is compromised (real time or aggregate of detection)
* risk classification: high, medium, low

### Configuring Identity Protection
* license requirements:
  * at least an Azure AD Premium P2 license
* user requirements:
  * `Conditional Access Administrator` or `Security Administrator` role
  * a test user account (optional)

### Introducing Password Protection
* detects and blocks global banned password list, weak passwords, and info within your Entra tenant
* checks on user passwords occurs on user password set actions
  * occurs in on prem hybrid AD DS or AAD
    * on prem DCs need two agents installed:
      * Azure AD Password Protection DC agent
      * Azure AD Password Protection proxy service

### Implementing Password Protection
* license requirements:
  * banned password list is included with all licenses
  * custom banned password lists require at least one Azure AD Premium P1 license
* user requirements:
  * `Security Administrator` role
  * AD DS on prem == domain admin
  * a test account

### demo: protecting identities and passwords

#### review legacy methods for creating Identity Protection policies
* no longer use this, but use Conditional Access
  * Entra ID> Manage/Security> protect/identity protection> protect/user risk policy + sign-in risk policy

#### create a user risk-based Conditional Access policy
* Entra ID> Manage/Security> protect/Conditional access
* create new policy via template
...
* create new policy
  * users>
    ...
    * exclude: break glass
  * conditions:
    * ![](2024-08-16-16-53-26.png)
  * grant:
    * ![](2024-08-16-16-54-00.png)
  * session:  
...
* create new policy
  * users>
    ...
    * exclude: break glass
  * conditions:
    * ![](2024-08-16-16-55-03.png)
  * grant:
    * ![](2024-08-16-16-55-18.png)
  * session:  
    * sign-in frequency: every time

#### simulate and investigate a risk
* simulate
  * if you have a user who is risky login who doesn't have MFA, their login will be blocked
  * if they have MFA, they will simply be prompted for MFA
* investigate
  * Entra ID> Manage/Security> protect/identity protection> Report/risky users

#### configure alerts
* Entra ID> Manage/Security> protect/identity protection> Report/risky users

#### configure Password Protection
* Entra ID> Manage/Security> manage/authentication methods> manage/password protection> mode: enforced or custom banned passwords list
...
### exploring hybrid identity
* Azure AD Connect syncs on prem AD DS to AAD
* sync methods:
  * Azure AD Connect sync: this is legacy solution, is an service that gets installed that relies on DB backend locally
  * Azure AD Connect cloud sync: agent that can live on any domain joined machine
* authentication methods:
  * password hash sync: sends hash of password to AAD so that AAD can verify the password
  * pass through authentication: deploy agents and AAD will ping those agents
  * federation: AD Federation Server servers
...
* password hash sync: sends hash of password to AAD so that AAD can verify the password
  ...
  * AD DS account restrictions are not applied in AAD (such as logon hours)
* pass through authentication: deploy agents and AAD will ping those agents
  * good user experience
  * AD DS account restrictions are applied
  * no support for Azure AD Connect cloud sync
* federation: AD Federation Server servers
  * all authentication occurs on-premises
  * can be compelx and difficult to maintain
  * requires password hash sync for business continuity
* see: https://learn.microsoft.com/en-us/entra/identity/hybrid/connect/choose-ad-authn#decision-tree
 
### exploring password writeback
* Azure AD Connect Sync dependant
* Requires Azure AD Premium P1
* helpdesk can password reset in AAD
* SSPR
* AD DS password policy compliance
* Identity self-remediation

### azure AD connect cloud sync requirements
* Azure AD Domain requirements:
  * at least one custom domain added
* Azure AD user requirements:
  * cloud-only `Global Adminsitrator` or `Hybrid Identity Administrator`
...
### prepare AAD (create custom domain to match the on prem AD DS domain)
* entra ID> manage/custom domains names> add custom domain> add domain name

### prepare AD DS
#### add the domain to AD DS
* access a DC
* Admin tools> AD domains and trusts
* at the root of the MMC snapin, right-click go to properties
* add the domain name

#### switch user principal names
* for each user, you can adjust the user logon names via the account tab on that's dsa.msc user properties
* https://microsoft.github.io/idfix/

### config Azure AD Connect Cloud Sync
* Entra ID> manage/Azure AD Connect
* Cloud sync> monitor/agents> download on premises agent
* install on DC (but can be installed on any server)

### password write back and SSPR
* powershell on the DC:
```
import-module "c:\program files\microsoft azure ad connection provisioning agent\microsoft.cloudsync.powershell.dll"
$globaladmincreds = get-credential
set-aadcloudsyncpasswordwritebackconfiguration -enable $true -credential $globaladmincreds
```
* Entra ID> manage/Azure AD Connect> Cloud sync> monitor/agents> verify
* configuration> new cloud sync configu
  * enable password hash sync
* Entra ID> manage/password reset> manage/properties> enable
* manage/authentication methoods> review
* manage/on premises> integration> enable password write back for synced users

## going passwordless

### introducing Passwordless Authentication
* something you are: biometric
* something you have: device, Microsoft Authenticator, FIDO2 security key

### exploring authentication options
* Windows Hello for Business: well suited for users with dedicated personal Windows devices
* Microsoft Authenticator: well suited for remote works or non-Windows devices
* FIDO2-compliant security keys: well suited where a mobile phone is not available (most secure)

### azure AD passwordless requirements
* Azure AD Role requirements:
  * to configure registration and authentication methods, you will need at least the `Authentication Policy Administrator` role
* additional requirements:
  * use the passwordless wizard to determine additional requirements: https://aka.ms/passwordlesswizard

### demo: enablign passwordless sign-in with Microsoft authenticator

#### explore passwordless wizard
* https://aka.ms/passwordlesswizard > Microsoft 365 admin center

#### enable Microsoft Authenticator and Temporary Access Pass as authentication methods
* Entra ID> Manage/Security> manage/authentication methods> manage/policies>
* click on Microsoft Authenticator> Enable and target: enabled, include> authentication mode: any or passwordless
* click on Temporary access pass> Enable and target: enabled, include all users

#### create a Temporary Access Pass
* Entra ID> user> access a user> Manage/Authentication methods> Add authentication method> Temporary access Pass> send to users

#### register a user using Microsoft Authenticator
* auth on a phone
* once completed delete the temporary access pass
...
### introducing Decentralized Identities
* identity verification/assurance is spread out across many IdPs.
* IdPs are a SPOF for your identity data, so decentralized identities is coming into the picture

#### components:
* `issuer`: issues credential to users and verifies the credentials of the `user`
* `account holder`/user: the user stores their credentials in a digital wallet and presents credentials to a `verifier`
* `verifier`: verifies `user` credentials with an `issuer`
* MSFT's product for this is called Entra Verified ID
  * AAD acts as an issuer

### Verified Identity Requirements
* AAD enabling Entra Verified ID
* need an Azure Subscription (including Free)
* need a key vault
* need a storage account
* probably need: azure DNS and web app
* users: Microsoft Authenticator
* Azure RBAC roles: `Global Administrator`, `Authentication Policy Administrator` and `Application Administrator`, Contributor access to manage resources

### Demo: Issuing Verified Identities

#### create an Azure Key Vault
* RG> create key vault
  * for access config, use Vault access policy (as currently recommended by MSFT)
  * grant access to your user
    * ![](2024-08-17-08-56-45.png)

#### set up verified ID
* ARM> Verified ID
* define organization settings> update
  * trusted domain may be something like https://did.rivercityai.com
  * key vault: new keyvault
* register decentralized> update
  * download and host file
* verify domain ownership:
  * download and host file

#### create a verified employee cred
* ARM> Verified ID> Manage/Credentials> create credential
* 

#### issue the verified identity using a sample app
* as described
...
## quiz
* Which of the following roles is the least privileged role in Azure Active Directory (Azure AD) to create a sign-in risk policy using Conditional Access?
  * Conditional Access Administrator
* Which of the following hybrid identity authentication methods is not supported with Azure AD Connect cloud sync?
  * Pass-through Authentication
* Which of the following authentication methods is NOT supported by both Azure AD Multi-Factor Authentication (MFA) and self-service password reset (SSPR)?
  * Windows Hello for Business
* What is the minimum Azure Active Directory (Azure AD) license required to enable security defaults?
  * Azure AD Free
...
### introducing azure access management
* users are automatically provided some default permissions to Entra ID Tenant, like reading the directory
  * in a subscription, there are no default permissions to users
* you grant access to users in a scope, this access allows certain actions
* groups of permissions are called Roles
* role assignment: is the binding between the users/groups of users to a role
 
### exploring the Azure Management hierarchy
* Entra ID tenent (Entra ID roles grant access to manage Entra ID items)
  * root management group (not generally visible)
    * management groups
      * Azure subscriptions
        * RG
          * resources
...
* administrative unit: sets of users, user groups, and/or devices that allow those users/user groups, scope to be set
* An Azure AD Premium P1 license is rquired for each administrative unit administrator.
* Administrative units cannot be nested
* only direct administrative group members can be managed
* administrative units have no effect on the default user permissions

### demo: managing Azure AD permission scope

#### elevate access as a Global Administrator
* ARM> Entra ID> Manage/Properties> Access management for Azure Resources toggle: enable
* ARM> Management Groups> select tenant root group> Access control> role assignments: verify scope

#### manage Administrative Units
* Entra ID> Manage/adminsitrative units> add> grant the admin
  * open the admin users> manage/users> add the users who should be admined by the admin
...
### differentiating azure AD roles

![](2024-08-17-09-24-21.png)
* naming convention is generally: [job function or service] [access level]

### azure role types
* Azure roles === "Azure RBAC roles"
* privileged administrator roles:
  * grant prived access
  * can manage access for other users
  * should be used sparingly
  * ie: owner, contributor, user access adminsitrator
* job function roles:
  * allow the management of specific Azure resources
  * should be used whenever possible
  * ie: virtual machine contributor, monitoring reader
* custom roles:
  * enable granular perm assignment
  * can be used to effectively apply the principle of least priv
* classic subscription administrator roles
  * account administrator: assigned to the user who created the subscription, granted full perms to the subscription
  * service administrator: assigned to the user who created the subscription, granted full perms to the subscription
  * co-administrator: granted full perms to the subscription

### differentiating azure roles
* permissions can be assigned at the control plane and the data plane
* Control Plane permissions: manage Azure resources
  * naming convention: "[resource] [access level]"
    * ie: "[Virtual Machine] Contributor"
  * access level hierarchy:
    * Owner: has full CRUD, but can also assign perms
    * Contributor: has full CRUD perms, can't assign perms
    * Operator: 
    * Developer: owns whatever is created, but can only create certain things.
    * Reader: generally read only
* Data Plane permissions: manage data stored within Azure resource
  * naming convention: "[resource] [sub-resource (optional)] Data [access level]"
    * ie: "[Storage] [Blob] Data [Contributor]"
  * access level hierarchy:
    * Owner: 
    * Elevated/Privileged: can grant access to other users to add data
    * Contributor: add data
    * Reader: read data

### assigning roles using groups
* Azure AD:
  * use role-assignable groups
  * group must be configured as role-assignable upon creation
  * role-assignable groups require an Azure AD Premium P1 license
  * Requires at least the `Privileged Role Adminsitrator` roles
  * membership must be assigned
  * both M365 and security griup types can be used
  * Group nesting is **not** supported
* Azure:
  * Create the group in AAD
  * assign the role to the group at the desired scope in the Azure mgmt hierarchy
  * membership can be assigned or dynamic
  * both M365 and security group types can be assigned

### demo: assign built-in roles

#### create a role-assignable group in AAD
* Entra ID> Manage/Group> new group> security group> Azure AD roles can be assigned to the group: yes
  * add roles: Helpdesk Administrator
* go to group> 

#### assign Virtual MAchine USer Login role at the subscription scope to the helpdesk team group
* ARM> Subscriptions> find subscription> Access control (IAM)> add> role assignment> search for role name, assign access to user> add members
...
### customizing AAD roles
* use built in roles whenever possible
* Custom Role Definition: collection of perms
  * Name and description
  * Actions
    * naming convention: "[type]/[sub-type]/[property set (optional)]/[permission]"
      * ie: "[microsoft.directory]/[users]/[contactinfo]/[update]"
* role assignment or role assignable group
  * grants permissions at the specified scope
* scopes:
  * can be Tenant, Adminsitrative units, applications

### customizing Azure (RBAC) Roles
* RBAC roles can contain both Control Plane or Data Plane actions within a single definition
* custom role definition:
  * name and description
    * Actions: applies to Control Plane permissions
    * NotActions: applies to Control Plane permissions
    * DataActions: applies to Data Plane permissions
    * DataNotActions: applies to Data Plane permissions
      * all actions' naming convention: "[company].[service provider name].[resource type].[action]"
        * ie: "[microsoft].[compute].[virtualmachine].[*]"
* role assignment:
  * Assignable Scopes: Management group, subscription, resource group, but not resources
  
### custom role requirements
* Custom AAD role requirements:
  * at least an Azure AD Premium P1 license
  * at least the `Privileged Role Administrator` role
* Custom Azure Role requirements
  * at least the `User Access Administrator` role

### demo: creating custom roles

#### create a customer azure AD role, review
* Entra ID> roles and administrators> new custom role
  * search for needed roles: microsoft.directory/users/manager/read, microsoft.directory/users/manager/update
* review in powershell
```
# review graph module is installed
install-module microsoft.graph

# find out which permissions are needed to run the get-mgrolemanagementdirectoryroledefinition for the graph connection
$scopes = (find-mggraphcommand -command get-mgrolemanagementdirectoryruledefinition | select -expandproperty permissions).name | sort -unique

# connect to the graph API endpoint with the necessary scopes
connect-mggraph -scopes $scopes
# authorize with oauth to grant the powershell module access to Azure control plane on your behalf
  #this is interactive

# get the role definition for the Organization Manager role

(get-mgrolemanagementdirectoryruledefinition -filter "DisplayName eq 'Organization Manager'").rolepermissions | convertto-json

```

#### create a custom Azure role
* ARM> Subscriptions> subscription> Access Control> Add> add custom role> start from scratch
* add permissions for VMs
...
* privileged role grants are:
  * not time boxed
  * should require approval
  * should require MFA
  * should require justification
  * should have access reviewed

### exploring Privileged Identity Management (PIM)
* PIM can manage: Entra ID roles, Azure RBAC Roles, and groups
* users can be assigned or eligible:
  * assigned:
    * privileges are avialable until they expire (and/or time bound)
    * useful for contractors and guests
    * do not require approval before using the role
  * eligible:
    * role must be activated before it can be used
    * activation remains until the max duration is reached (default: up to 24 hours)
    * additional actions can be requested prior to activation

### Privileged Identity Management (PIM) requirements
* license requirements:
  * Azure AD Premium P2 (any user, any approver)
* Entra ID roles
  * at least `privileged role administrator` role
* Azure RBAC resources
  * at least the `user access administrator` role
  * `global administrators` in Entra ID can also elevate access
  * once managed, azure resources cannot be unmanaged

### demo: enable PIM for Azure AD and Azure RBAC

#### assign an eligible role for Azure resources and review
* ARM> Azure AD Privileged identity management> manage/azure resources> select Discovery resources> select subscription> manage resource
* go into subscription> maanage/roles> add assignment> Contributor> can assign as eligible or active
* manage> settings> find the Contributor role... can adjust settings (duration, etc)

#### assign an eligible role for Azure AD
* ARM> Azure AD Privileged identity management> manage/Azure AD roles> manage/roles> search for Global Administrator> active assignments
* remove active assignment
* Add assignment> eligible
...
### exploring privilege sprawl
* review the lifecycle of an employee... when employee functional title changes, they may accumulate roles that they no longer need.

### types of access reviews
* group membership: reviewers can be specified, group owners, or members
  * reviews are created in access reviews or Azure AD groups
* Applications:
  * revieweres can be specified or it can be a self-review
  * reviews are created in access reviews
* roles:
  * reviewres can be specified, or it can be a self-review
  * reviews are created in Privileged Identity Management
* entitlements:
  * reviewers can be specified, members, or it can be a self-review
  * reviews are created ine entitlement management

### access review requirements for roles
* license requirements:
  * Azure AD Premium P2: for users who create reviews and who acces the reviews
  * access reviews for service principals require a Microsoft Entra Workload Identities Premium plan
* Azure AD roles:
  * at least the `Privileged Role Administrator` role
* Azure resources roles:
  * at least the `User Access Administrator` role

### demo: completing access reviews

#### create an access review for prived Azure AD roles
* go to entra.microsoft.com> identity governance/privileged identity management> Manage/Azure AD roles> Manage/Access reviews> new
  * ![](2024-08-17-10-41-33.png)
  * ![](2024-08-17-10-41-56.png)
    * high prived roles
  * ![](2024-08-17-10-42-16.png)

#### perform an access review as one of the delegated reviewers
* email is received
  * ![](2024-08-17-10-42-52.png)
* approve with reason
  * ![](2024-08-17-10-43-21.png)

#### complete the access review using the Azure portal
* go to entra.microsoft.com> identity governance/privileged identity management> Manage/Azure AD roles> Manage/Access reviews> 
  * go to review> current/results> stop> will automatically apply
...
* previously covered:
  * application registration creates a service principal
    * service principal can be granted roles and permisions to access Azure AD secured resources
* ...but Azure can also use user delegated permissions to access an Azure AD secured resource.
  * this is driven by user consent actions via interactive prompts

### providing consent
* User Consent: action granted via interactive prompts by the user
  * user must have signed in at least once for the application to access resources on behalf of the user
  * user concsnt can be either dynamic or static
* admin consent: consent is granted on behalf of users by an admin
  * `Cloud Application Administrator`
  * some high-level privs require admin consent
  * application can access user data without the user being signed in
  * if user attempts to access resource that they can not access, then the user is prompted with "admin approval required" notice
* scopes are bundles of privs that can be granted to apps

### demo: delegate application permissions

#### review concent settings
* Entra ID> manage/enterprise apps> security/consent and permissions> manage> user consent or permission classifications

#### register an app in portal
* Entra ID> manage/app registration> new registration

#### manage app permissions
* within the new application:
  * copy app name, application client ID, 
  * manage/API Permissions> add a permission
    * Microsoft Graph
      * delegated permissions> mail.read permission


#### config and test the app
* the app must call Graph itself for authentication
  * ![](2024-08-17-10-58-22.png)
...
## quiz
* Which of the following statements is FALSE about user and admin consent for delegated application permissions?
  * Admin consent can be dynamic.
...
* prep videos:
  ...
  * https://learn.microsoft.com/en-us/shows/exam-readiness-zone/preparing-for-az-500-secure-networking-2-of-4
  * https://learn.microsoft.com/en-us/shows/exam-readiness-zone/preparing-for-az-500-secure-compute-storage-and-databases-3-of-4
  * https://learn.microsoft.com/en-us/shows/exam-readiness-zone/preparing-for-az-500-manage-security-operations-4-of-4
* practice exams: do NOT use brain dumps as they can be outdated and have errors.
  * https://practice-exam.acloud.guru/6c32f58c-4529-4c3c-9c28-5927228efb56
  * https://practice-exam.acloud.guru/55deaeea-c5df-4aa7-94cb-1314ed01c5cf
  * https://practice-exam.acloud.guru/a2c621a4-f5f2-416e-8df9-0ffbf83ce1b5
  * https://practice-exam.acloud.guru/f12c9436-41ff-485d-a1c5-22fb80401d0e
  * https://learn.microsoft.com/en-us/credentials/certifications/azure-security-engineer/practice/assessment?assessment-type=practice&assessmentId=57&practice-assessment-type=certification
...
* the AZ500 cert lasts a year, you can re-cert easily in a non-proctored, open book, free online test.
